=== ABOUT ===
I have built a webscraping code using beautifulsoup to make buying custom PC parts easier in Pakistan.
There are numerous websites for custom parts and it becomes too difficult to search for the best price.
Hence, based on your search input, I search reputable websites and output the name and prices to an excel file ordered from low to high prices.
